...
/**
 * Reusable confirm-with-reason modal. Powers the destructive/decisive admin
 * actions that require (or optionally accept) a note: suspend, reinstate,
 * cancel a payout request, and approve/reject a slot-shift. Keeps the reason
 * validation (`>= 5` chars when required) in one place.
 */
...
export interface ReasonModalProps {
  ...
  onClose: () => void;
  title: string;
  /** Contextual explainer above the textarea. */
  description?: React.ReactNode;
  /** CTA label. */
  confirmLabel: string;
  /** Whether the reason is required (>=5 chars) or optional. */
  reasonRequired?: boolean;
  reasonLabel?: string;
  placeholder?: string;
  /** "danger" gives a red CTA; "primary" the brand green. */
